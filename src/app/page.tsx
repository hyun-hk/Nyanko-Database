...
import { Cat, Swords, Shield, Zap, Target, Menu, Trophy, Clock, Star, Search, Sun, Moon, ChevronRight, Book, Gamepad, Skull, Users } from 'lucide-react'
...
const ColoredIcon = ({ icon: Icon, color, ...props }: ColoredIconProps) => (
  <motion.div
...
const ChapterSection = ({ title, description, icon: Icon, iconColor, image, color, items }: ChapterSectionProps) => {
  return (
    <motion.div 
      key={title}
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-12 p-8 rounded-3xl overflow-hidden">
        ...
        <div className="md:w-1/2 space-y-6">
          <h3 className="text-3xl font-bold mb-4 text-gray-800 dark:text-gray-100 flex items-center">
            <Icon className="mr-3" size={32} color={iconColor} />
            {title}
          </h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <motion.div 
          ...
          animate="visible"
        >
          <motion.div key="dailyMission" variants={itemVariants}>
          ...
          <motion.div key="popularCharacters" variants={itemVariants}>
            <Card className="bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow duration-200 overflow-hidden">
              <CardContent className="p-6">
                <h3 className="font-bold mb-4 text-xl text-gray-800 dark:text-gray-100 flex items-center">
          ...
          <motion.div key="latestStages" variants={itemVariants}>
            <Card className="bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow duration-200 overflow-hidden">
              <CardContent className="p-6">
                <h3 className="font-bold mb-4 text-xl text-gray-800 dark:text-gray-100 flex items-center">
